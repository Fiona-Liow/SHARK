...
### Step 3: Move and Rename Source Code to Web Root
...
3. **Important:** Rename the extracted folder from `SHARK-main` to exactly `SHARK`. 
> **Why?** XAMPP relies on the exact folder name to route your web browser requests. Renaming it ensures your local URL maps correctly.
